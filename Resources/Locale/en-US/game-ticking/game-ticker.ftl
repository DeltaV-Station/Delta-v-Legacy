...
game-ticker-player-join-game-message = Welcome to Delta-v SS14! If this is your first time playing, be sure to read the game rules, and don't be afraid to ask for help in LOOC (local OOC). You can get whitelisted by joining the Discord from www.delta-v.org.
