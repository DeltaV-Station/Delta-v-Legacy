...
reagent-desc-syntheticblood = Synthetic blood, a cruetly free alternative for Arachnees. Originally Developped by Lia Rogers.

reagent-name-inactiveblood = inactive blood
reagent-desc-inactiveblood = Synthetic blood without the oxygen, causes asphyxiation if drank by an Arachnee